...
namespace Yurt_Otomasyonu
{
    public partial class personelgirisi : Form
    {
        ...
        private void vtkayit()
        {
            ...
            con.Open();
            string ekle = "insert into personel(kadi,sifre,adi,soyadi,dtarihi,cinsiyet,adres,telefon,tcno) values (@kadi,@sifre,@adi,@soyadi,@dtarihi,@cinsiyet,@adres,@telefon,@tcno)";
